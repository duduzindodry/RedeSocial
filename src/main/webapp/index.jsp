...
<head>
  ...
  <link rel="icon" href=imagens/desktop1.png>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container mt-4">
    <h2 class="mb-3">Feed de Postagens</h2>
    <div class="card mb-3">
      <div class="card-body">
        <h5 class="card-title">Usuário 1</h5>
        <p class="card-text">Esta é uma postagem de exemplo na rede social.</p>
      </div>
    </div>
    <div class="card mb-3">
      <div class="card-body">
        <h5 class="card-title">Usuário 2</h5>
        <p class="card-text">Outra postagem fictícia para o protótipo.</p>
      </div>
    </div>
  </div>
